  ...
  const handleObj = (value: any, key: string = '') => {
    if (Object.prototype.toString.call(value) === '[object Object]') {
      ...
      Object.keys(value).map((k) => {
        ...
        if (
          Object.prototype.toString.call(value[k]) === '[object Object]' &&
      ...
      >
          ...
          >
            ...
            <Stack direction='row' alignItems={'center'}>
              ...
              <Switch
                ...
                onChange={(e: any) => setExpandNestedObjects(e.target.checked)}
              />
            </Stack>
            {curTab === 1 && (
              <Stack direction='row' alignItems={'center'}>
        ...
        {curTab === 1 && (
          <Box sx={{ position: 'relative' }}>
            ...
            <CopyToClipboard text={csv} onCopy={handleClick}>
              <ContentCopyIcon
                sx={{
                  zIndex: 1,
                  position: 'absolute',
