...
const videoTypes = [
  { label: 'AVI', value: 'video/x-msvideo', suffix: 'avi' },
  { label: 'MP4', value: 'video/mp4', suffix: 'mp4' },
  { label: 'MPEG', value: 'video/mpeg', suffix: 'mpeg' },
  { label: 'OGG', value: 'video/ogg', suffix: 'ogg' },
  { label: '3GP', value: 'video/3gpp', suffix: '3gp' },
  { label: 'TS', value: 'video/mp2t', suffix: 'ts' },
  { label: 'WEBM', value: 'video/webm', suffix: 'webm' },
  { label: 'FLV', value: 'video/flv', suffix: 'flv' },
  { label: 'MOV', value: 'video/quickTime', suffix: 'mov' },
];
  ...
  const getFmtUrlByFile = async (file: File, conversion: string) => {
    try {
      ...
      const outputName =
        file.name.split('.')[0] +
        '.' +
        videoTypes.find((it) => it.value === conversion)?.suffix;
        ...
        <Box>
          <Select
            ...
            renderValue={(selected: string) => {
              if (selected)
                return videoTypes.filter((it) => it.value === selected)[0]
                  ?.label;
            ...
            onClick={() =>
              download(
                ...
                record.file.name.split('.')[0] +
                  '.' +
                  videoTypes.find((it) => it.value === record.conversion)!
                    .suffix
              )
            }
          >
    ...
    >
      ...
      >
        ...
        <Select
          ...
          renderValue={(selected: string) => {
            if (selected)
              return videoTypes.filter((it) => it.value === selected)[0]?.label;
      ...
      >
        ...
        <Box ref={messageRef}>Upload video and convert video format</Box>
      </Box>
      {/* <Button
